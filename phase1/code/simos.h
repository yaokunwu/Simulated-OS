...
void initialize_mframe_manager ();   // called by system.c
void initialize_agescan ();   // called by system.c
...
void context_in (int pid); // should not be here, used by idle.c

void initialize_process_manager ();  // called by system.c
...
void insert_termIO (int pid, char *outstr, int type);
